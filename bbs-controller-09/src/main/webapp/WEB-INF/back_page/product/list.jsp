...
<table cellspacing="1" cellpadding="0" width="100%" border="0" class="pn-ltable">
	...
	<c:forEach items="${pagination.list }" var="product">
		<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
			...
			<td align="center">
			<a href="${pageContext.request.contextPath}/product/detail.do?id=${product.id}" class="pn-opt">查看</a> |<a href="${pageContext.request.contextPath}/app/app.do" title="app">app</a>| <a href="${pageContext.request.contextPath}/product/edit.do?id=${product.id}" class="pn-opt">修改</a> | <a href="javascript:void(0)" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt" onclick="deleteobj(${product.id})" >删除 </a> | <a href="${pageContext.request.contextPath}/sku/list.do?id=${product.id}" class="pn-opt">库存</a>
			</td>
		</tr>
		</c:forEach>
	</tbody>
