...
import com.xxt.common.utils.ResourcesUtil;
...
public class ResultUtil {
    ...
    public static void throwExcepion(String messageCode) throws ExceptionResultInfo{
		throw new ExceptionResultInfo(ResultUtil.createFail(Config.MESSAGES, Integer.parseInt(messageCode)));
	}
	...
	public static SubmitResultInfo createSubmitResult(String messageCode){
		return createSubmitResult(ResultUtil.createSuccess(Config.MESSAGES, Integer.parseInt(messageCode)));
	}
	/**
	 * 创建提交结果信息，包括明细信息
	 * @param resultInfo
